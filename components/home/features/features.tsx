...
export default function Features() {
    ...
    return (
        <section className='py-24 w-full px-4 sm:px-6 lg:px-8 relative'>
                        ...
                        <div
                            ...
                            <div className={`relative h-full p-8 rounded-2xl border transition-all duration-300 ${
                                hoveredFeature === feature.id
                                    ? 'border-primary-border bg-primary-bg/5 shadow-xl shadow-primary-solid/5'
                                ...
                                {hoveredFeature === feature.id && (
                                    <div className='absolute bottom-8 right-8 animate-fade-in'>
                                        <div className='p-2 bg-primary-bg/10 rounded-lg'>
                                            <FaArrowRight className='w-4 h-4 text-primary-solid/80' />
                                        </div>
                                    </div>
                                )}
                            </div>
